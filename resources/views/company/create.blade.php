                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('company.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="company_title" type="text" class="form-control" name="company_title"
                                        autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="company_contact_phone"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Contact phone') }}</label>
                                <div class="col-md-6">
